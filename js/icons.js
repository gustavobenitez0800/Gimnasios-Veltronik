...
const ICONS = {
    ...
    wallet: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>`,
    ...
    diamond: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 3h12l4 6-10 13L2 9z"></path><path d="M2 9h20"></path><path d="M12 22V9"></path><path d="M6 3l6 6 6-6"></path></svg>`,
    ...
    dumbbell: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6.5 6.5a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"></path><path d="M17.5 13.5a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"></path><path d="M14.5 6.5a2 2 0 1 1 0 4 2 2 0 0 1 0-4z"></path><path d="M9.5 13.5a2 2 0 1 1 0 4 2 2 0 0 1 0-4z"></path><line x1="6.5" y1="10.5" x2="6.5" y2="13.5"></line><line x1="17.5" y1="10.5" x2="17.5" y2="13.5"></line><line x1="9.5" y1="8.5" x2="14.5" y2="8.5"></line><line x1="9.5" y1="15.5" x2="14.5" y2="15.5"></line></svg>`,
    ...
    door: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v14a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1V7a5 5 0 0 0-5-5Z"></path><path d="M14 22v-4a2 2 0 1 1 4 0v4"></path><path d="M1 7h6v15H1z"></path></svg>`,
    ...
    // Additional Icons for Emojis Replacement
    ...
    userX: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="18" y1="8" x2="23" y2="13"></line><line x1="23" y1="8" x2="18" y2="13"></line></svg>`,
    ...
    lineChart: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><line x1="3" y1="22" x2="21" y2="22"></line></svg>`,
    ...
    // Team & Platform Icons
    userCog: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><circle cx="19" cy="11" r="2"></circle><path d="M19 8v1"></path><path d="M19 13v1"></path><path d="M21.6 9.5l-.87.5"></path><path d="M17.27 12l-.87.5"></path><path d="M21.6 12.5l-.87-.5"></path><path d="M17.27 10l-.87-.5"></path></svg>`,
...
/**
 * Obtiene un icono SVG por nombre
...
function getIcon(name, className = 'icon') {
    // Convert kebab-case to camelCase (e.g., 'arrow-left' -> 'arrowLeft')
    const camelCaseName = name.replace(/-([a-z])/g, (g) => g[1].toUpperCase());

    const icon = ICONS[camelCaseName] || ICONS[name];
    if (!icon) {
        console.warn(`Icon "${name}" not found`);
        return '';
    }
    // Agregar clase al SVG
    return icon.replace('<svg', `<svg class="${className}"`);
}

/**
 * Inserta iconos en elementos con data-icon attribute
 * Uso: <span data-icon="dashboard"></span>
 */
function initIcons() {
