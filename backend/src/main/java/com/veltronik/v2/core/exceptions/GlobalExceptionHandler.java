...
public class GlobalExceptionHandler {
    ...
    /**
     * Atrapa errores de lógica de negocio (ej: "El email ya está registrado").
     * Retorna HTTP 400.
     */
    ...
    /**
     * Atrapa credenciales inválidas en el login.
     * Retorna HTTP 401 sin exponer detalles internos.
     */
    @ExceptionHandler(BadCredentialsException.class)
    public ResponseEntity<Map<String, Object>> handleBadCredentials(BadCredentialsException ex) {
        return buildErrorResponse(HttpStatus.UNAUTHORIZED, "Email o contraseña incorrectos");
    }

    /**
     * Atrapa cuando el usuario no tiene permisos para la operación.
     * Retorna HTTP 403.
     */
    @ExceptionHandler(AccessDeniedException.class)
    public ResponseEntity<Map<String, Object>> handleAccessDenied(AccessDeniedException ex) {
        return buildErrorResponse(HttpStatus.FORBIDDEN, "No tenés permisos para realizar esta acción");
    }

    /**
     * Atrapa ResponseStatusException (404, 403) lanzadas desde servicios (anti-IDOR).
     * Retorna el código HTTP y mensaje apropiado.
     */
