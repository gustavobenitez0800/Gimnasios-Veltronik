...
// Solo se listan rubros que el backend soporta (enum BusinessType en Java) — antes
// "Club Deportivo" mandaba CLUB y el backend lo rechazaba. Hoy hay UNO: el gimnasio.
// Agregar una tarjeta acá sin su valor en el enum = alta rota con 400.
