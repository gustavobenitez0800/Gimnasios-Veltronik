...
// ============================================
// ⭐ EL BUG: el mapeo que carga el formulario no incluía `planId`. Como guardar manda todos
// los campos del formulario, el que faltaba llegaba vacío y pisaba lo que había.
//
...
import { CAMPOS_DEL_SOCIO, getInitialMemberForm, mapMemberToForm } from './formSocio';
