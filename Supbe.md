...
CREATE TABLE public.gym_members (
    ...
    CONSTRAINT gym_members_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.clients(id),
    CONSTRAINT gym_members_membership_type_id_fkey FOREIGN KEY (membership_type_id) REFERENCES public.membership_types(id)
);
